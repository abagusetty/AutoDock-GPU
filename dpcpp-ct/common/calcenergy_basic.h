...
/* DPCT_ORIG #define COS_HALF_INFINITESIMAL_RADIAN
 * cos(HALF_INFINITESIMAL_RADIAN)*/
#define COS_HALF_INFINITESIMAL_RADIAN sycl::cos(HALF_INFINITESIMAL_RADIAN)
/* DPCT_ORIG #define SIN_HALF_INFINITESIMAL_RADIAN
 * sin(HALF_INFINITESIMAL_RADIAN)*/
