...
typedef struct dpct_type_107824
{
	int           num_of_atoms;
...
typedef struct dpct_type_318778
{
...
typedef struct dpct_type_125566
{
	int rotlist_const[MAX_NUM_OF_ROTATIONS];
} kernelconstant_rotlist;

typedef struct dpct_type_365999
{
...
typedef struct dpct_type_152663
{
